...
export default function Hero(){
    return <section className="absolute top-0 bg-bannerImg bg-no-repeat bg-cover bg-bottom h-full md:h-[75vh] w-full">
            ...
            <div className="px-4 pd:mx-10 mt-20 w-full py-10 md:py-16">
                ...
                <div className="text-center">
                    <span className="text-2xl text-wrap">
                        Streamline the process for organizers to manage and sell tickets effortlessly.<br />
